...
FEATURE_CONFIG = {
    ...
    "corner_detection": {"max_corners": 100, "quality_level": 0.3, "min_distance": 7},
    "color_analysis": {"kmeans_clusters": 16, "sample_rate": 0.1},
}
...
RL_CONFIG = {
    ...
    "training": {"total_timesteps": 100000, "eval_freq": 5000, "save_freq": 10000},
}
